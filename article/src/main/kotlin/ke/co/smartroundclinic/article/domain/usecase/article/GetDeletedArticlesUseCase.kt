...
class GetDeletedArticlesUseCase(private val repository: ArticleRepository) {
    suspend operator fun invoke(page: Int, size: Int): DefaultResponse<ArticlePageResult?> =
        repository.getDeleted(page, size).toDefaultResponse { pair ->
