...
class GetArticlesByCategoryUseCase(private val repository: ArticleRepository) {
    suspend operator fun invoke(categoryId: String, page: Int, size: Int): DefaultResponse<ArticlePageResult?> =
        repository.getByCategory(categoryId, page, size).toDefaultResponse { pair ->
