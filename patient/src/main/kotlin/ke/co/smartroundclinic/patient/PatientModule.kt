...
import ke.co.smartroundclinic.patient.presentation.controller.patientRatingController
...
fun Application.patientModule() {
    ...
    val patientRatingService: PatientRatingService by inject()
    routing {
        personalInformationController(personalInformationService)
        patientRatingController(patientRatingService)
    }
}
