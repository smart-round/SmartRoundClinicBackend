...
class GetPaymentsByPatientUseCase(private val repository: PaymentRepository) {
    suspend operator fun invoke(patientId: String, page: Int, size: Int): DefaultResponse<PaymentsPageRes?> =
