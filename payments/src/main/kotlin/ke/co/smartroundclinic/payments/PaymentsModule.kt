...
import ke.co.smartroundclinic.payments.presentation.controller.intaSendPaymentController
...
fun Application.paymentsModule() {
    ...
    val intaSendPaymentService: IntaSendPaymentService by inject()
    routing {
        paymentController(paymentService)
        intaSendController(intaSendService)
        intaSendPaymentController(intaSendPaymentService)
    }
}
